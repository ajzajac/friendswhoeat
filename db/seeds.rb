...
# Restaurant.create(name: "Chipotle", cuisine: "Tacos", location: "NYC")
# Restaurant.create(name: "Taco Bell", cuisine: "Tacos", location: "NYC")
# Restaurant.create(name: "Tonys Pizza", cuisine: "Pizza", location: "Brooklyn")
# Restaurant.create(name: "Minka Ramen", cuisine: "Ramen", location: "Lower East Side")
# Restaurant.create(name: "Stanton Social", cuisine: "Brunch", location: "Lower East Side")
# Restaurant.create(name: "Beatrice Inn", cuisine: "New American", location: "West Village")
# Restaurant.create(name: "Brass Monkey", cuisine: "Bar", location: "Meatpacking District")
# Restaurant.create(name: "Kung-Fu Tea", cuisine: "Bubble Tea", location: "FiDi")
# Restaurant.create(name: "Dead Rabbit", cuisine: "Cocktail Bar", location: "FiDi")
